...
System.register(['Languages/LocalizationHelper.js'], function (_export, _context) {
    ...
    var Localization, _createClass, SetTenantFeaturesWindow;
    ...
    return {
        ...
        execute: function () {
            ...
            _export('SetTenantFeaturesWindow', SetTenantFeaturesWindow = function () {
                function SetTenantFeaturesWindow() {
                    _classCallCheck(this, SetTenantFeaturesWindow);
                }

                _createClass(SetTenantFeaturesWindow, [{
                    key: 'load',
                    value: function load() {
                        ...
                        $(document).ready(function () {
                            ...
                            var $form = $("#setTenantFeatures");
                            var $reset = $(".js-reset-features");
                            var tenantService = abp.services.app.tenant;
                            $reset.click(function () {
                                var id = $("#TenantId").val();
                                abp.ui.setBusy($form, tenantService.resetFeatures(id).done(function () {
                                    periModal.close();
                                }));
                            });
                            ...
                            $form.on("submit", function (e) {
                                ...
                                abp.ui.setBusy($form, tenantService.setFeatureValuesForTenant(formData).done(function () {
                                    periModal.close();
                                }));
                            });
                        });
                ...
                return SetTenantFeaturesWindow;
            }());

            _export('SetTenantFeaturesWindow', SetTenantFeaturesWindow);
        }
    };
});