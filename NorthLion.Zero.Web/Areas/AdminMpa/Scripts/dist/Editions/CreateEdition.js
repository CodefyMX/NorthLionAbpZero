...
System.register(["Languages/LocalizationHelper.js"], function (_export, _context) {
    ...
    var Localization, _createClass, CreateEditionWindow;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("CreateEditionWindow", CreateEditionWindow = function () {
                function CreateEditionWindow() {
                    _classCallCheck(this, CreateEditionWindow);
                }

                _createClass(CreateEditionWindow, [{
                    key: "load",
                    value: function load() {
                        $(document).ready(function () {
                            ...
                            $form.on("submit", function (e) {
                                ...
                                abp.ui.setBusy($form, editionService.createEdition(formData).done(function () {
                                    periModal.close();
                                }));
                            });
                        });
                ...
                return CreateEditionWindow;
            }());

            _export("CreateEditionWindow", CreateEditionWindow);
        }
    };
});